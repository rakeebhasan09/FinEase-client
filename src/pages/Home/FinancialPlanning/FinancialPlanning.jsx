		...
		<section className="pb-20 px-6">
			<div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
				...
				<div>
					...
					{/* Button */}
					<button className="px-6 py-3 common-btn text-white font-semibold rounded-lg shadow">
						Start Tracking Now →
					</button>
				</div>
				...
				<div className="flex justify-center h-full">
					<div className="w-full max-w-md h-full py-20 px-10 flex flex-col items-center justify-center text-center rounded-2xl border-[3px] ">
